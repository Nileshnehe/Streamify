...
import { getOutgoingFriendRequest, getRecommendedUsers, getUserFriends, sendFriendRequest } from '../services/api';
...
const HomePage = () => {
  ...
  const { data: recommendedUsers = [], isLoading: loadigUsers } = useQuery({
    queryKey: ["users"],
